...
class customadapter : RecyclerView.Adapter<viewholder>() {
    ...
    val quantity = arrayListOf<String>("First","Second","Third")
    ...
    override fun onBindViewHolder(holder: viewholder, position: Int) {
        ...
        holder.v.text_view_title.text=titlev

        val qunatityev = quantity.get(position)
        holder.v.text_view_quantity.text=qunatityev
    }
